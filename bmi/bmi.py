...
class WeightInput(ctk.CTkFrame):
    def __init__(self, parent,  weight_float):
        ...
        plus_button = ctk.CTkButton(self, text = '+', font = font, command = lambda: self.update_weight(('plus', 'large')) , text_color = BLACK, fg_color = LIGHT_GRAY, hover_color = GRAY, corner_radius = BUTTON_CORNER_RADIUS)
        ...
        small_minus_button = ctk.CTkButton(self, text = '-', font = font,command = lambda: self.update_weight(('minus', 'small')),  text_color = BLACK, fg_color = LIGHT_GRAY, hover_color = GRAY, corner_radius = BUTTON_CORNER_RADIUS)
